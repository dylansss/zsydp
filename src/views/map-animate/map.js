...
// import sichuanjson from '../../../public/assets/json/sichuan.json'
// 排序
...
export class World extends Mini3d {
  ...
  addEvent() {
    ...
    this.eventElement.map((mesh) => {
      ...
      //   console.log(event.target.userData, 'addEvent-mousedown-event');
      //   // return
      ...
      //   // console.log(event.target.userData, 'addEvent-mouseover-event');
  ...
  setLabelMove(adcode, type = "up") {
    ;[...this.allProvinceLabel, ...this.allProvinceNameLabel, ...this.allProvincePonitNameLabel].map((label) => {
  ...
  createBar() {
    ...
    this.allProvincePonitNameLabel = []
    data.map((item, index) => {
      // 网格
      ...
      let namePointLabel = labelPointNameStyle(item, index, new Vector3(x, -y - 1.5, this.depth + 0.4))
      ...
      this.allProvincePonitNameLabel.push(namePointLabel)
    })
    ...
    function labelNameStyle(data, index, position) {
      ...
      label.init(
        `<div class="provinces-name-label"  style="pointer-events: all; z-index: 11"><div class="provinces-name-label-wrap code-${data.adcode}" data-adcode=${data.adcode}>${data.name}</div></div>`,
        position
      )
      label.element.querySelector('.provinces-name-label-wrap').addEventListener("click", (e) => {
        console.log(e.target, ' label.element.addEventListener');
      ...
      // label.element.querySelector('.provinces-name-label-wrap').addEventListener("mouseenter", (e) => {
      //   console.log(e.target, '111111111111111111-mouseenter');
      //   const points = label.element.nextElementSibling
      //   points.querySelector('.provinces-name-point-label').style.display = 'block'
      //   return
      // });
      // label.element.querySelector('.provinces-name-label-wrap').addEventListener("mouseleave", (e) => {
      //   console.log(e.target, '2222222222222222-mouseleave');
      //   const points = label.element.nextElementSibling
      //   setTimeout(() => {
    ...
    // 点位弹窗标签
    function labelPointNameStyle(data, index, position) {
      let label = self.label3d.create("", "provinces-name-point-label", true)
      label.init(
        `<div class="provinces-name-point-label" style="pointer-events: all;display: none;"><div class="provinces-name-point-label-wrap" data-adcode=${data.adcode}>${data.name}11111</div></div>`,
        position
      )
      // label.element.querySelector('.provinces-name-point-label').addEventListener("click", (e) => {
      //   console.log(e.target, ' label.element.addEventListener');
      //   return
      // });
      // label.element.querySelector('.provinces-name-point-label').addEventListener("mouseover", (e) => {
      //   console.log(e.target, ' label.element.addEventListener-mouseover');
      //   return
      // });
